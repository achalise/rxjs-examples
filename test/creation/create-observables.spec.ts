...
import { evenNumberStream } from '../../src/number-stream-observable';
import { ResultCollector } from '../../src/result-collector';
...
describe(`Observable Creation Examples - Providing your own observer - also showing that  
    ...
    it(`Should not listen to the observable after unsubscribe is called`, (done) => {
        ...
        let stream$ = evenNumberStream();
        let sub: Subscription = stream$.subscribe(t => {
